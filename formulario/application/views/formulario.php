		...
		<ul>
			...
			<li>
				Ciudad: <select name="city">
						<option value="zrg"
							<?=($arrayUser[6] == 'Zaragoza')?'selected':''; ?> >
							Zaragoza
						</option>
						<option value="bcn"
							<?=($arrayUser[6] == 'Barcelona')?'selected':''; ?> >
							Barcelona
						</option>
						<option value="blb"
							<?=($arrayUser[6] == 'Bilbao')?'selected':''; ?> >
							Bilbao
						</option>
						</select>
			</li>
			<li>
				Lenguaje: Java <input type="radio"
									name="coder"
									value="java"
